...
import {
  ...
  Dark,
  C2,
} from "../../../../styles/SmartTheme/blocos-tipograficos/elements";
...
const Comp = ({ props }) => {
  return (
    <div
      className={
        _css +
        " Card grow | A4 box pad-0 group shadow sh-op-5 h:sh-lvl-1 h:sh-op-10 | bg-C4 bg-tom-l1 bevel bv-C2 bv-op-20 bv-dir-r | flex dir-col align-stretch gap-0"
      }
      p="struct"
    >
      <div b="true"></div>
      <div c="true">
        <Link href={props.url}>
          <a
            p="struct"
            className="PictureContainer | box group aspect-2x1 pad-0 min-w-40p grow  | bevel bv-over-content bv-mix-color bv-C2 bevel-backdrop-filter contrast-140 brightness-120 bv-op-0 h:bv-op-30 bv-end-100 bv-start-0 |  flex dir-row layers main-first "
          >
            <div b="true"></div>
            <div c="true">
              <div
