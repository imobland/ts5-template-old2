...
import { SocialButtons as configComponent } from "../../../../../../src/config/components/Footer";
...
const styles = {
  ...
  "dark-border": ` ${C} h:C0 a:c-tom-d4 |  | bg-C4 bg-op-0 border bd-C0 bd-op-20 a:bd-tom-d5 h:bd-op-100 bd-side-all`,
            ...
            <div className="" key={i} p="struct">
              ...
              <div c="true">
                <Link href={Network.url}>
                  <a
                    className={`bel pad-1b S+2 | ` + styles[styleName]}
                    p="struct"
                    data-tip={Network.displayName}
                    data-for="footer-bt-social"
                    target="_blank"
